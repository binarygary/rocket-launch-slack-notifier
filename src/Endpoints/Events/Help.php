...
In that channel I\'ll post a 24 hour launch notice, a 1 launch hour notice and a 5 minute launch notice for every orbital launch I know about.
...
`launch [who/where]` Try `@ground_control launch SpaceX` or `@ground_control launch cape canaveral` and I\'ll and reply with the next launch I know of by that provider.
